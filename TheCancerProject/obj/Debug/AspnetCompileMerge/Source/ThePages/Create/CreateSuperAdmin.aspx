<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateSuperAdmin.aspx.cs" Inherits="TheCancerProject.ThePages.CreateSuperAdmin" %>
            ...
            <div class="col-md-6" style="width: 100%">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Enter Super Admin Details</h3>
                </div><!-- /.box-header -->
                    <!-- /.box-header -->
