<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateHospitalUser.aspx.cs" Inherits="TheCancerProject.ThePages.CreateHospitalUser" %>
            ...
            <div class="col-md-6" style="width: 100%">
              ...
              <div class="box">
                <div class="box-header" style="background-color:steelblue">
                  <h3 class="box-title" style="color:whitesmoke; font-family:Helvetica, Arial, sans-serif;">Create Super Admin</h3>
                </div><!-- /.box-header -->
                    <!-- /.box-header -->
