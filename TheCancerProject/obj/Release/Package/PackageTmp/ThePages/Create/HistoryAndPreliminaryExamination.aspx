     ...
     <section class="header">
        ...
        <section class="content">
          <div class="row">
           ...
           <%-- <input type="date" id="dateMenarche" name="bday" class="form-control" runat="server">--%>
           <input type="text" runat="server" class="form-control" id="txtMenarche" title="Menarche" required="" placeholder="Enter Menarche (Age)"/>
              </div>
