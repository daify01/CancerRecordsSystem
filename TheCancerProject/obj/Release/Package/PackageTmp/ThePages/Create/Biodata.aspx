          ...
          <div class="row">
            ...
            <asp:DropDownList ID="ddlTitle" runat="server" AppendDataBoundItems="True"
                ...
                <div class="form-group">
                        ...
                        <input runat="server" type="text" class="form-control" id="txtFirstName" title="Firstnames" pattern="[A-Za-z]*" maxlength="50" required="" placeholder="Enter First Name"/>
               </div>
                <div class="form-group">
            ...
            <input type="date" id="dateDateofBirth" name="bday" class="form-control" runat="server">
              </div>
