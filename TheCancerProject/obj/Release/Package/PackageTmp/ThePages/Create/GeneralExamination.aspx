...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <section class="content-header">
        ...
        <asp:ListBox ID="ddlGeneralExam" ClientIDMode="Static" CssClass="form-control" runat="server"  SelectionMode="Multiple"></asp:ListBox> 
            ...
            <input type="text" runat="server" class="form-control" id="txtBMI" disabled="" title="BMI" required="" placeholder="This Value is Auto Calculated using weight and Height"/>
              </div>

                               <div class="form-group">
                                <label for="txtBSA">BSA(m^2)</label>
                <input type="text" runat="server" class="form-control" id="txtBSA" disabled="" title="BSA" required="" placeholder="This value is Auto Calculated using weight and height"/>   
                               </div>
        ...
        <asp:ListBox ID="ddlLocationOfLesion" ClientIDMode="Static" CssClass="form-control" runat="server"  SelectionMode="Multiple"></asp:ListBox>
            ...
            <asp:DropDownList ID="ddlSymmetry" runat="server" AppendDataBoundItems="True" CssClass="form-control" ClientIDMode="Static" 
                        ...
                        <input type="text" runat="server" class="form-control" id="txtShape" title="Shape" required="" placeholder="Enter Shape"/>                            
                            </div>

                                <%--<div class="checkbox icheck">
                <label>Visible Mass</label>
                  <input type="checkbox" id="chkVisibleMass"/>                 
              </div>--%>
                                <div class="form-group">
        ...
        <asp:ListBox ID="ddlQuadrantLocated" ClientIDMode="Static" CssClass="form-control" runat="server"  SelectionMode="Multiple"></asp:ListBox>
            <%--<asp:DropDownList ID="ddlLocationOfLesion" runat="server" AppendDataBoundItems="True" CssClass="form-control" ClientIDMode="Static" 
                        ...
                        <input type="text" runat="server" class="form-control" id="txtColorOfSkinArea" title="ColorOfSkinArea" required="" placeholder="Enter Color Of Skin Area"/>  
                            </div>
                ...
                <input type="text" runat="server" class="form-control" id="txtPulseRRate" title="Pulse Rate" required="" placeholder="Enter Pulse RAte"/>   
                               </div>
