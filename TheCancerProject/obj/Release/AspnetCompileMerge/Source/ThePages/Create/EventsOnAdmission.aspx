...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <section class="content">
          <div class="row">
            ...
            style="border: 5px groove #99CCFF; font-family: 'Comic Sans MS'; font-size: large; color: #FFFF00; background-color: #800000"></p>  
                        ...
                        <textarea runat="server" class="form-control" id="Textarea3" cols="50" rows="10" required=""/>                              
                            </div> 

                                <div class="form-group">
                                <label for="txtChemotherapyRegimen">Chemotherapy Regimen</label>
                        <textarea runat="server" class="form-control" id="Textarea4" cols="50" rows="10" required=""/>                              
                            </div> 

                                <div class="form-group">
                                <label for="txtRadiotherapyRegimen">Radiotherapy Regimen</label>
                        <textarea runat="server" class="form-control" id="Textarea5" cols="50" rows="10" required=""/>                              
                            </div> 
                        ...
                        <textarea runat="server" class="form-control" id="Textarea7" cols="50" rows="10" required=""/>                              
                            </div> 
    ...
    <script type="text/javascript">
        $(document).ready(function () {
             $('#ddlInitialDiagnosis').select2({ placeholder: "Please Select TypeOfDischarge" });
        });
    </script>
    <script type="text/javascript">
        $(function () {
