...
{
    public partial class CreateHospitallAdmin : System.Web.UI.Page
    {
        ...
        protected void searchsubmit_OnServerClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(DropDownRole.SelectedItem.Text) && !DropDownRole.SelectedItem.Text.Equals("HospitalAdmin"))
                ...
                IList<HospitalUser> adminUserList = new HospitalUserDAO().RetrieveUser(userName, UserRole.HospitalAdmin, selectedHospital);
